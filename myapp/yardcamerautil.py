...
import threading
from myapp.final.oldcare.track import CentroidTracker
from myapp.final.oldcare.track import TrackableObject
...
# 全局变量
prototxt_file_path='myapp/final/models/mobilenet_ssd/MobileNetSSD_deploy.prototxt'
...
model_file_path='myapp/final/models/mobilenet_ssd/MobileNetSSD_deploy.caffemodel'
output_fence_path = 'myapp/final/supervision/fence'
                    ...
                    # to determine direction
                        ...
                        if not to.counted:
                            ...
                            # center line, count the object
                                ...
                                command = '%s myapp/final/inserting.py --event_desc %s --event_type 4 --event_location %s' % (
